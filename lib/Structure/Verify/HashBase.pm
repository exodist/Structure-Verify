package Structure::Verify::HashBase;
use strict;
use warnings;
...
{
    no warnings 'once';
    $Structure::Verify::HashBase::VERSION = '0.003';
    *Structure::Verify::HashBase::ATTR_SUBS = \%Object::HashBase::ATTR_SUBS;
}
...
sub import {
    ...
    my $isa       = _isa($into);
    my $attr_subs = $Structure::Verify::HashBase::ATTR_SUBS{$into} ||= {};
    my %subs      = (
        ($into->can('new') ? () : (new => \&_new)),
        (map %{$Structure::Verify::HashBase::ATTR_SUBS{$_} || {}}, @{$isa}[1 .. $#$isa]),
        (
            map {
                my $p = substr($_, 0, 1);
                my $x = $_;
...
Structure::Verify::HashBase - Build hash based classes.
...
Subclass it
    ...
    use base 'My::Class';
    use Structure::Verify::HashBase qw/bat/;
...
declare it before loading L<Structure::Verify::HashBase>.
...
To generate accessors you list them when using the module:
    ...
    use Structure::Verify::HashBase qw/foo/;
